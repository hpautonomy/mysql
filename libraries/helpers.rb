module Opscode
  module Mysql
    module Helpers
      def default_version_for(platform, platform_family, platform_version, implementation)
        keyname = keyname_for(platform, platform_family, platform_version)
        PlatformInfo.mysql_info[platform_family][keyname][implementation]['default_version']
      rescue NoMethodError
        nil
      end

      def package_name_for(platform, platform_family, platform_version, implementation, version)
        keyname = keyname_for(platform, platform_family, platform_version)
        PlatformInfo.mysql_info[platform_family][keyname][implementation][version]
      rescue NoMethodError
        nil
      end
        ...
        @mysql_info ||= {
          ...
          'debian' => {
            ...
            '12.04' => {
              ...
              'mariadb' => {
                'default_version' => '5.5',
                '5.5' => 'mariadb-server-5.5'
              },
              'galera' => {
                'default_version' => '5.5',
                '5.5' => 'mariadb-galera-server-5.5'
              }
            },
            '13.10' => {
              'mysql' => {
